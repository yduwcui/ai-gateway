...
To use the latest version, you can use the following commands to install the `aigw` CLI from the source code:

```shell
go install github.com/envoyproxy/ai-gateway/cmd/aigw@v0.4.0
```
