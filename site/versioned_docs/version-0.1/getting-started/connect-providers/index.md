...
2. Remove the basic configuration with the mock backend
   ...
   ```shell
   kubectl delete -f https://raw.githubusercontent.com/envoyproxy/ai-gateway/refs/tags/v0.1.4/examples/basic/basic.yaml
...
3. Download configuration template
   ...
   ```shell
   curl -O https://raw.githubusercontent.com/envoyproxy/ai-gateway/refs/tags/v0.1.4/examples/basic/basic.yaml
   ```
